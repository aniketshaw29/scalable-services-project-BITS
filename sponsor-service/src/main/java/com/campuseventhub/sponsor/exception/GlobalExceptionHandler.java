...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleNotFound(SponsorNotFoundException ex, WebRequest req) {
        return buildError(HttpStatus.NOT_FOUND, ex.getMessage(), req);
    }

    @ExceptionHandler(SponsorAlreadyLinkedException.class)
    public ResponseEntity<Map<String, Object>> handleConflict(SponsorAlreadyLinkedException ex, WebRequest req) {
