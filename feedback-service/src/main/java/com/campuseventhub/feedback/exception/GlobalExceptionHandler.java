...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleNotFound(FeedbackNotFoundException ex, WebRequest req) {
        return buildError(HttpStatus.NOT_FOUND, ex.getMessage(), req);
    }

    @ExceptionHandler(FeedbackAlreadySubmittedException.class)
    public ResponseEntity<Map<String, Object>> handleConflict(FeedbackAlreadySubmittedException ex, WebRequest req) {
